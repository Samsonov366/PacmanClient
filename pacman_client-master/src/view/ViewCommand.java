...
public class ViewCommand {
	...
	private JButton restart, start, step, pause, parcourir;
	private CommandSender controler;
	
	public ViewCommand( CommandSender controler) {
	...
	public void windowGenerator() {
		...
		//Create the label.
		JLabel sliderLabel = new JLabel("Nombre de tours par seconde", JLabel.CENTER);
		...
		JLabel turnNumber= new JLabel("Tour : 0", JLabel.CENTER);

		JPanel jPanel = new JPanel();
		parcourir = new JButton("Choisir map");
		jPanel.add(parcourir);

		panelBelow.add(sliderLabel);
		panelBelow.add(turnNumber);
		panelBelow.add(sliderLaps);
		panelBelow.add(jPanel);
	...
	public void set(JButton parcourir) {
